...
# compare with prev count... if current player count is less than previous player count... set previous player count and store true...
...
# it must be run after ALL checks have been done.

# return false if $t0 is 0.
