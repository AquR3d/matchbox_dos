...
$execute if data storage mb:data game.deceased_players[{UUID:$(UUID),role:"SPARK"}] run return run \
...
$execute if data storage mb:data game.deceased_players[{UUID:$(UUID),role:"MEDIC"}] run return run \
