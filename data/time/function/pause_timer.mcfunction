...
$execute unless data storage timer:data running_timers[{id:"$(id)"}] run return \
...
$data modify storage timer:data paused_timers append from storage timer:data running_timers[{id:"$(id)"}]
